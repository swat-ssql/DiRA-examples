...
The image is created using the add_3d.directions() command in the DiRA package. 
...
It shows the marginal effect of each of the variables within the models above. 
