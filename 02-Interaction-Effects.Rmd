...
This example highlights a regression surface estimated from a model with an interaction term. The regression examines the relationship between: 
  ...
  - **Explanatory variable**: A binary variable that is true/1 if a majority of the adults in the county had attended college in 2016, whether or not they attained a degree. It is false/0 otherwise. 
