...
The intent of these 2D graphics are to show that the simple linear regression defines a direction in the multiple regression surface. By omitting $x_2$ from the model, we end up modeling the change in $y$ produced by a *joint direction* between $x_1$ and $x_2$ in the regression surface.
...
Tips to improve the view:
  ...
  - Hover over individual scatterpoints in any of these images to see which county and state the point represents.
